...
namespace PracticalTwenty.Db.DatabaseContext
{
    public class UserDbContext : DbContext
    {
        ...
        private List<AuditEntry> OnBeforeSaveChanges()
        {
            ...
            foreach (var entry in ChangeTracker.Entries())
            {
                ...
                var auditEntry = new AuditEntry
                {
                    ...
                    // TempProperties are properties that are only generated on save
        ...
        private Task OnAfterSaveChangesAsync(List<AuditEntry> auditEntries)
        {
            ...
            // For each temporary property in each audit entry - update the value in the audit entry to the actual value
